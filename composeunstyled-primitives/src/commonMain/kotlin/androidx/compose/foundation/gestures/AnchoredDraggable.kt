...
): UnstyledDraggableAnchors<T> =
  MapUnstyledDraggableAnchors(DraggableAnchorsConfig<T>().apply(builder).anchors)
...
@OptIn(ExperimentalFoundationApi::class)
private class MapUnstyledDraggableAnchors<T>(private val anchors: ObjectFloatMap<T>) :
  UnstyledDraggableAnchors<T> {
