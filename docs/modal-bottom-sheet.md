...
An unstyled Modal Bottom Sheet component for Jetpack Compose and Composable Multiplatform that can be used to implement Modal Bottom Sheets with the styling of your
choice.

Sits on top of every other piece of content on your UI, stackable and jam packed with features. Supports custom animations, configurable peek height, inset support & works great with soft keyboards, dynamic sizing and of course fully accessible.
